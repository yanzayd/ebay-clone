  ...
  return (
    <div>
      ...
      <main className="max-w-6xl mx-auto p-10 border">
        <h1 className="text-4xl">Add an Item to the Marketplace</h1>
        <h2 className="text-xl font-semibold pt-5">Details</h2>
        <p className="pb-5">
          By adding an items to the marketplace, you're Minting essentially an
          NFT of the item into your wallet which we can then list for sale!
        </p>
        <div className="flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5">
          <img
            className="border h-60 w-60 objectif-contain"
